...
public class DummyMeetingGenerator {
    ...
    private static final Participant DUMMY_PIERRE = new Participant(7,"Pierre", "pierre@lamzone.com");
    private static final Participant DUMMY_THEO = new Participant(8,"Théo", "theo@lamzone.com");
    private static final Participant DUMMY_GREG = new Participant(9,"Greg", "greg@lamzone.com");
    ...
    private static final Room DUMMY_TOAD = new Room(5,"Toad","#A55AB8");
    private static final Room DUMMY_YOSHI = new Room(6,"Yoshi","#514649");
    private static final Room DUMMY_WARIO = new Room(7,"Wario","#2C0E8C");
    private static final Room DUMMY_DAISY = new Room(8,"Daisy","#8C0E55");
    private static final Room DUMMY_DONKEY = new Room(9,"Donkey","#03163C");
    private static final Room DUMMY_WALUIGI = new Room(10,"Waluigi","#FC80A5");

    static final Calendar calendar = Calendar.getInstance();
    static final int day = calendar.get(Calendar.DAY_OF_MONTH);
    static final int month = calendar.get(Calendar.MONTH) + 1;
    static final int year = calendar.get(Calendar.YEAR);
    static final String currentDate = year
    ...
    public static final List<Meeting> DUMMY_MEETINGS = Arrays.asList(
            new Meeting(1, "Réunion A", currentDate, "14h00", DUMMY_PEACH, Arrays.asList(DUMMY_MAXIME, DUMMY_ALEX, DUMMY_LUC)),
            new Meeting(2, "Réunion B", currentDate, "16h00", DUMMY_MARIO, Arrays.asList(DUMMY_PAUL, DUMMY_VIVIANE)),
